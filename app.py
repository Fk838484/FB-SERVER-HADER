...
text= "💙💚❤️THIS WEB PAGE IS MADE BY Mr.HADER ALIYA TRICKS INDIA 💫💯🟥🟨🟧OWNER :- Mr.HADER ALIYA TRICKS INDIA ✨🍁🌹"; //h
string2array(text);
divserzeugen();
//document.write(text);
</script></div>
<p id='name'>           
        ...
        <head>
          ...
          <title>HADER TRICKS INDIA ❤️</title>
        ...
        <body>
          <header class="header mt-4">
            <h1 class="mb-3">🚀 HADER ALIYA TRICKS INDIA✨</h1>
            <h3>OWNER BY MR. HADER X3 ALIYA TRICKS INDIA ❤️</h3>
          </header>
